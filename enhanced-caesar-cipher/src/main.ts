...
// encrypt elements
const $encryptTextElement = document.getElementById(
  'encrypt-text-input'
) as HTMLTextAreaElement;
const $encryptKeyElement = document.getElementById(
  'encrypt-key-input'
) as HTMLInputElement;
const $encryptModeElement = document.getElementById(
  'encrypt-mode-select'
...
// decrypt elements
const $decryptTextElement = document.getElementById(
  'decrypt-text-input'
) as HTMLTextAreaElement;
const $decryptKeyElement = document.getElementById(
  'decrypt-key-input'
) as HTMLInputElement;
const $decryptModeElement = document.getElementById(
  'decrypt-mode-select'
) as HTMLSelectElement;
const $decryptBruteForceElement = document.getElementById(
...
$decryptBruteForceElement.addEventListener('change', () =>
  adjustDecryptOnCheckboxClick()
);
...
async function decrypt() {
  ...
  if (!doBruteForce) {
    ...
    decryptService
      .bruteForceDecrypt(textInput, modeInput)
      .subscribe((result) => {
